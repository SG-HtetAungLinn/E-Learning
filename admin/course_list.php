...
if (isset($_GET['delete_id'])) {
    ...
    $res = deleteData('courses', $mysqli, "`id`='$delete_id'");
    if ($res) {
        $url = $admin_base_url . "course_list.php?success=Course Delete Success";
        header("Location: $url");
        exit;
    }
}
...
$res = selectData('courses', $mysqli, $column = "*", $where = "", $order = "ORDER BY id DESC");
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Course/</span>List</h4>
            <div class="">
                <a href="<?= $admin_base_url ?>course_create.php" class="btn btn-primary">Create Course</a>
            </div>
        </div>
        <div class="row">
        ...
        $('.delete_btn').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "course_list.php?delete_id=" + id
                }
            });
